  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        ...
        {AiToolsData.map((tool,index) => (
            <div key={index} className='p-8 max-w-xs m-4 rounded-lg bg-[#FDFDFE] shadow-lg border border-gray-100 hover:-translate-y-1 transition-all duration-300 cursor-pointer' onClick={() => user && navigate(tool.path) }>
